...
import stephenImage from '../assets/media/stephen.png'; // ✅ Import the image

const StephenHawkingCard = ({ learnMoreUrl = "https://en.wikipedia.org/wiki/Stephen_Hawking", avatarImage = stephenImage }) => {
  ...
  const person = {
    ...
    description:
      "Despite being diagnosed with ALS at 21 and given just a few years to live, Hawking became one of the most influential scientists of our time, authoring groundbreaking theories on black holes and cosmology."
  };
...
StephenHawkingCard.propTypes = {
  learnMoreUrl: PropTypes.string,
  avatarImage: PropTypes.string,
};

export default StephenHawkingCard;
